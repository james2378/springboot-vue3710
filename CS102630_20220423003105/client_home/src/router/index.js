...
const routes = [
	...
	//宠物领养添加路由
	{
		path: '/pet_adoption/edit',
		name: '/pet_adoption_edit',
		component: () => import('../views/pet_adoption/edit.vue')
	},
	//宠物知识列表路由
	{
		path: '/pet_knowledge/list',
		name: '/pet_knowledge_list',
		component: () => import('../views/pet_knowledge/list.vue')
	},
	//宠物知识详情路由
	{
		path: '/pet_knowledge/details',
		name: '/pet_knowledge_details',
		component: () => import('../views/pet_knowledge/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "宠物领养管理系统-home";
	document.title = title;
	document.logo = "宠物领养管理系统"
})
