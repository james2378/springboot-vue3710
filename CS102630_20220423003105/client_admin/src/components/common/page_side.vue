<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/adopter/table" v-show="user_group == '管理员' || $check_action('/adopter/table')"><span>领养者</span></el-menu-item>
			<el-menu-item index="/publisher/table" v-show="user_group == '管理员' || $check_action('/publisher/table')"><span>发布者</span></el-menu-item>
