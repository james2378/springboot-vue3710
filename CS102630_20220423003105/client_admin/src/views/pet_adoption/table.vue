<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="宠物编号">
						<el-input v-model="query.pet_number"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/pet_adoption/table','add') || $check_action('/pet_adoption/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            <el-button v-if="user_group == '管理员' || $check_action('/pet_adoption/table','del') || $check_action('/pet_adoption/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="adopter_number" label="领养者编号"
				v-if="user_group == '管理员' || $check_field('get','adopter_number')" min-width="200">
				<template slot-scope="scope">
					{{ get_user_adopter_number(scope.row['adopter_number']) }}
				</template>
			</el-table-column>
			<el-table-column prop="adopter_name" label="领养者姓名"
				v-if="user_group == '管理员' || $check_field('get','adopter_name')" min-width="200">
			</el-table-column>
			<el-table-column prop="adopter_telephone" label="领养者电话"
				v-if="user_group == '管理员' || $check_field('get','adopter_telephone')" min-width="200">
			</el-table-column>
			<el-table-column prop="adoption_instructions" label="领养说明"
				v-if="user_group == '管理员' || $check_field('get','adoption_instructions')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/pet_adoption/table','set') || $check_action('/pet_adoption/view','set') || $check_action('/pet_adoption/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/pet_adoption/table','set') || $check_action('/pet_adoption/view','set') || $check_action('/pet_adoption/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/pet_adoption/get_list?like=0",
				url_del: "~/api/pet_adoption/del?",
